/**
 * Playwright Test port of `installer-strictness.test.ts`
 */
...
import { createTempWorkspace, cleanupTempWorkspace, runInstaller } from './helpers.ts';

test.describe('installer strictness / UX', () => {
            ...
            checks: [
              {
                ...
                description:
                  'Ensures shell checks can read vars from .env when not in process.env',
