...
test.describe('Installation Steps', () => {
  ...
  test('Step 1: Check Environment Variables', async () => {
    ...
    expect(result1.missing.length, 'Should have missing variables').toBeGreaterThan(0);
  ...
  test('Step 3: Download Projects @smoke', async () => {
    test.skip(!stepResults.get('download-repos'), 'Skipping Step 3: Step 2 failed');
  ...
  test('Step 4: Check Environment Again @smoke', async () => {
  ...
  test('Step 6: Setup Projects @smoke', async () => {
    test.skip(!stepResults.get('setup-modules'), 'Skipping Step 6: Step 5 failed');
    ...
    expect(stepResult, 'Step result should be saved').not.toBeNull();
