...
test.describe('Installation Steps', () => {
  ...
  test('@smoke Step 1: Check Environment Variables', async () => {
    ...
    expect(await isStepCompleted(sharedWorkspace, 'check-env')).toBe(true);
  ...
  test('@smoke Step 2: Download Repos', async () => {
    ...
    expect(await isStepCompleted(sharedWorkspace, 'download-repos')).toBe(true);
  ...
  test('@smoke Step 3: Download Projects', async () => {
    ...
    expect(await isStepCompleted(sharedWorkspace, 'download-projects')).toBe(true);
  ...
  test('@smoke Step 4: Check Environment Again', async () => {
    ...
    expect(await isStepCompleted(sharedWorkspace, 'check-env-again')).toBe(true);
  ...
  test('@smoke Step 5: Setup Modules', async () => {
    ...
    expect(await isStepCompleted(sharedWorkspace, 'setup-modules')).toBe(true);
  ...
  test('@smoke Step 6: Setup Projects', async () => {
    ...
    expect(await isStepCompleted(sharedWorkspace, 'setup-projects')).toBe(true);
  ...
  test('@smoke Step 7: Verify Installation', async () => {
    ...
    expect(await isStepCompleted(sharedWorkspace, 'verify-installation')).toBe(true);
