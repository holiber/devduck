...
<img src="media/logo.png" alt="Barducks" width="18" /> [![tests](https://img.shields.io/github/actions/workflow/status/holiber/barducks/after-merge-ci.yml?branch=main&label=tests)](https://github.com/holiber/barducks/actions/workflows/after-merge-ci.yml?query=branch%3Amain)
