...
1. A **task file** under `docs/tasks/` describing the change (or linking to an external ticket).
   - File name format: `docs/tasks/YYYY-MM-DD-HHMM-short-description.md` (24h time, minutes)
   - The PR must add at least one new file matching `docs/tasks/YYYY-MM-DD-HHMM-*.md`
