...
- **The slow-tests metric includes BOTH Unit tests AND E2E tests** (pw_installer). The total count aggregates slow tests across both test suites, with a breakdown available in `bySuite`.
